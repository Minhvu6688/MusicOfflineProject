package com.example.musicofflineproject;
...
public class MainActivity extends AppCompatActivity implements SongChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView playPauseImg = findViewById(R.id.playPauseCard);
        ...
        if (ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STROGE) == PackageManager.PERMISSION_GRANTED)
        {
            getMusicFile();
        }
        else {
            ...
            {
                requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORGE},11);
            }
            else{
                getMusicFile();
            }
